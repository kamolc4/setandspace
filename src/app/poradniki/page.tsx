...
export default function PoradnikiPage() {
  return (
    <>
      ...
      >
        <Breadcrumb items={[{ label: "Poradniki" }]} />
        ...
        <header style={{ marginBottom: "3.5rem" }}>
          ...
          <p className="text-body" style={{ maxWidth: "480px", marginTop: "1rem" }}>
            Piszę o tym, co wiem: o przygotowaniu do nagrań, roli światła, procesie produkcji
            i tym, co sprawia, że film dobrze służy przestrzeni.
          </p>
        </header>
        ...
        {sortedArticles[0] && (
          <Link
            href={`/poradniki/${sortedArticles[0].slug}`}
            style={{
              display: "block",
