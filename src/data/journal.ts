...
Najlepsze filmy hotelowe często korzystają z konkretnej pory roku — warto to zaplanować z wyprzedzeniem. Lato daje więcej naturalnego światła, jesień — dramę i kolory, zima w górach — magię mrozu i świec.
...
Dobre przygotowanie przekłada się bezpośrednio na efekt — i oszczędza czas ekipy na planie.
    `.trim(),
    author: null,
...
Zaplanuj nagranie na porę, gdy do kluczowych pomieszczeń wpada najlepsze naturalne światło. Najczęściej jest to poranek lub wczesne popołudnie — zależy od orientacji mieszkania.
  ...
  },
  {
    ...
    content: `
W fotografii mówi się, że zdjęcia robi się światłem, a nie aparatem. W filmie wnętrzarskim i architektonicznym ta prawda jest podwójnie ważna — bo kamera porusza się przez przestrzeń i rejestruje, jak światło zmienia się z każdym krokiem.

## Naturalne światło jest królem
...
export function getLatestArticles(count = 3): JournalArticle[] {
  return [...articles]
    .sort(
      (a, b) =>
